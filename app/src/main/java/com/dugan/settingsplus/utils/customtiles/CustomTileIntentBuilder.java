 ...
 */
public final class CustomTileIntentBuilder {
     ...
     */
    public CustomTileIntentBuilder(@NonNull Context context, @NonNull String action) {
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setLabel(@Nullable String label) {
        mLabel = label;
        return this;
    }
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setContentDescription(@Nullable String contentDescription) {
        mContentDescription = contentDescription;
        return this;
    }

    @NonNull
    public CustomTileIntentBuilder setIconPackage(@NonNull String iconPackage){
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setIconResource(@DrawableRes int bitmapResource) {
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setOnClickPendingIntent(@Nullable PendingIntent pi) {
        mOnClickIntent = pi;
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setOnClickBroadcast(@Nullable Intent intent) {
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setOnLongClickPendingIntent(@Nullable PendingIntent pi) {
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setOnLongClickBroadcast(@Nullable Intent intent) {
     ...
     */
    @NonNull
    public CustomTileIntentBuilder setVisible(boolean visible) {
        mVisible = visible;
        return this;
    }
